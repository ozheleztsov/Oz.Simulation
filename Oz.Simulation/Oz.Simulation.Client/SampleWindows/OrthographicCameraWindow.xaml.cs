...
public partial class OrthographicCameraWindow : Window
{
    public OrthographicCameraWindow()
    {
        InitializeComponent();
        SetMatrixCamera();
    }
