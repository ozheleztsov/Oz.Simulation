...
public abstract class Viewport3DDecorator : FrameworkElement, IAddChild
{
    ...
    public UIElement? Content
    {
        ...
        set
        {
            ...
            if (!(value is System.Windows.Controls.Viewport3D or Viewport3DDecorator))
            {
            ...
            OnViewport3DDecoratorContentChange(oldContent, value);
            ...
            BindToContentsWidthHeight(value);
    ...
    public Viewport3D? Viewport3D
    {
        get
        {
            ...
            while (true)
            {
                ...
                if (currContent is Viewport3D content)
                {
                    viewport3D = content;
                    break;
                }
    ...
    void IAddChild.AddChild(object? value)
    {
        ...
        Content = (UIElement)value! ?? throw new ArgumentNullException(nameof(value));
    }
    ...
    protected override Visual GetVisualChild(int index)
    {
        ...
        throw new ArgumentOutOfRangeException(nameof(index), originalIndex, "Out of range visual requested");
    }
    ...
    /// <param name="constraint">The "upper limit" on the size of an element</param>
    private static void MeasureUiElementCollection(UIElementCollection collection, Size constraint)
    {
    ...
    private static void ArrangeUiElementCollection(UIElementCollection collection, Size constraint)
    {
        // measure the pre viewport visual visuals
        foreach (UIElement uiElem in collection)
        {
